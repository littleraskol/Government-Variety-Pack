...
I think there are like... I wanna say 30? Maybe even 40 at this point? Too many to list, and anyway, isn't "discovering" them from civic/authority/ethos combos half the fun? They fall into three broad categories:
...
-Two plans I have for expansion will be released as new, separate mods. The first will add "advanced" civics that should radically change the way you play. The second will focus on hive minds.

-New Authority types: This is going to be tough because what I have planned - adding hereditary versions of Democratic and Oligarchic authorities - doesn't really gel with the way succession works in the game. I'll have to monkey around with events.
