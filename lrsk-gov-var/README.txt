...
-New Casino Mysticism civic (Not Materialist) provides -25% pop demotion time, +25% colony development speed, and allows the Grand Casino branch building, which provides the host planet with XXXXX, and provides the megacorp with +15% Branch Office Value.
