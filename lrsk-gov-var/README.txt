...
-New Vacation Experience Planning civic (Xenophile) provides +15% trust growth rate and +20 trust cap, and -10% pop amenities usage, and allows the Galactic Excursions Office branch building, which provides the host planet with +50% Xenophile attraction and -15% pop amenities usage, and provides the megacorp with increased Branch Office Value that scales with the proportion of the planetary population that is Xenophile.
-New Heritage Trust civic (Xenophobe) provides +5 stability, and allows the Heritage Museum branch building, which provides the host planet with +50% Xenophobe attraction and +5% citizen pop happiness, and provides the megacorp with increased Branch Office Value that scales with the proportion of the planetary population that is Xenophobe.
