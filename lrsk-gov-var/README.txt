...
-New Casino Mysticism civic (Not Materialist) provides -25% pop demotion time, +25% colony development speed, and allows the Grand Casino branch building, which provides the host planet with +10% crime, +10 amenities, and +5% trade value, while enabling random beneficial and detrimental events for both the planet and the corp. It provides the megacorp with +15% Branch Office Value and +5 energy.
