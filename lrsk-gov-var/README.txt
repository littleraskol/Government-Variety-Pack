...
-New Investigation & Security Services civic (Authoritarian) provides -15% crime, and allows the Professional Protection Office branch building, which provides the megacorp with increased Branch Office Value that scales with the proportion of the planetary population that is Authoritarian. The host planet gets +50% Authoritarian attraction and either two Investigator jobs (produces -20 crime, -10% Worker power) or (if the providing corp is criminal) two Suppressor jobs (produces -10% Worker power, +5% Worker output).
