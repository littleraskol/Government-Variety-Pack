...
-Knight hall buildings provide Realm Cavalier jobs scaling with owner's "martial achievement" (based on techs and traditions).
...
--Now available to all non-gestalt, non-spiritualist and authoritarian empires. (Yes, you can have a cult of the "brilliant" CEO now if you want.)
--Councilor provides +1.5% influence production and -1.5% war exhaustion per level.
...
-Updated civic/government/etc flavor text to accommodate possible nomads.
...
--Events that change traits as player advances through psi ascension should be called more promptly (added to on_tradition_picked on-action)
-Updated compat version number.
